...
insert into sessions values (1, 15, 1, DATE_SUB(CURRENT_TIMESTAMP,interval 40 MINUTE ), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 180 MINUTE), CURRENT_DATE, CURRENT_DATE);
insert into sessions values (2, 16, 2, DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 240 MINUTE), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 180 MINUTE), CURRENT_DATE, CURRENT_DATE);
insert into sessions values (3, 17, 3, DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 240 MINUTE), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 180 MINUTE), CURRENT_DATE, CURRENT_DATE);
insert into sessions values (4, 15, 1, DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 180 MINUTE), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 120 MINUTE), CURRENT_DATE, CURRENT_DATE);
insert into sessions values (5, 16, 2, DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 180 MINUTE), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 120 MINUTE), CURRENT_DATE, CURRENT_DATE);
insert into sessions values (6, 18, 2, DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 120 MINUTE), DATE_SUB(CURRENT_TIMESTAMP , INTERVAL 60 MINUTE), CURRENT_DATE, CURRENT_DATE);
